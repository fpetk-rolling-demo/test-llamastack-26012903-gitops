# 📦 test-llamastack-26012903-gitops
...
This repository contains the GitOps deployment manifests for **test-llamastack-26012903**. These Kubernetes manifests define all the resources needed to deploy the application to your OpenShift/Kubernetes cluster via ArgoCD.
...
| 📂 **components/test-llamastack-26012903/** | Kustomize base and overlays for all Kubernetes resources |
...
```
components/test-llamastack-26012903/
...
|----------|------|-------------|
| 🖥️ **Deployment** | `test-llamastack-26012903` | Streamlit UI application |
| 🦙 **Deployment** | `test-llamastack-26012903-llama-stack` | Llama Stack inference server |
| 🦙 **Deployment** | `test-llamastack-26012903-ollama` | Ollama for safety/guardrails |
| ☸️ **Deployment** | `test-llamastack-26012903-mcp-server` | Kubernetes MCP Server |
| 🌐 **Services** | Various | Internal service networking |
| 🔀 **Route** | `test-llamastack-26012903` | External access to Streamlit UI |
| 🔐 **RBAC** | `test-llamastack-26012903-mcp-*` | Permissions for cluster introspection |
| 💾 **PVC** | `test-llamastack-26012903-ollama-data` | Persistent storage for Ollama models |
...
| Resource | Link |
|----------|------|
| 📝 **Source Repository** | [https://github.com/fpetk-rolling-demo/test-llamastack-26012903](https://github.com/fpetk-rolling-demo/test-llamastack-26012903) |
